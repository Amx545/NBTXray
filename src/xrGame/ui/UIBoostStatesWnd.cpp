...
void CUIBoostStatesWnd::InitFromXml(CUIXml& xml, LPCSTR path) 
{
    ...
    constexpr std::tuple<EBoostParams, cpcstr> booster_list[] = {
        ...
        {eBoostGraveImmunity, "indicator_booster_grave"}, 
        {eBoostHealthIncrease, "indicator_booster_health_increase"},
        {eBoostPowerIncrease, "indicator_booster_power_increase"}, 
        {eBoostSniper, "indicator_booster_sniper"},
        {eBoostDoubleShot, "indicator_booster_double_shot"}, 
        {eBoostSpeedShot, "indicator_booster_speed_shot"},
        {eBoostSpeedReload, "indicator_booster_speed_reload"},
        {eBoostMoveSpeedIncrease, "indicator_booster_movespeed_increase"},
        {eBoostJumpIncrease, "indicator_booster_jump_increase"}
    };
